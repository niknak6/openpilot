...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"ClairvoyantDriverV2CalibrationParams", PERSISTENT},
    {"ClairvoyantDriverV2Drives", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"ClairvoyantDriverV2LiveTorqueParameters", PERSISTENT},
    {"ClairvoyantDriverV2Score", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    ...
    {"ToyotaTune", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_VEHICLES},
